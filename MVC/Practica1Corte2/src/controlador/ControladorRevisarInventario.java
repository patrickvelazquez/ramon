 ...
 * @author Konakun
 */
public class ControladorRevisarInventario implements ActionListener {
    private vdlgRevisarInventario vista;
    private Gasolina gasolina;
    private BombaGasolina bomba;
    
    public ControladorRevisarInventario(vdlgRevisarInventario vista, Gasolina gasolina, BombaGasolina bomba){
        this.vista = vista;
     ...
     * @return the vista
     */
    public vdlgRevisarInventario getVista() {
        return vista;
    }
     ...
     */
    public void setVista(vdlgRevisarInventario vista) {
        this.vista = vista;
    }
    ...
    public void actionPerformed(ActionEvent e) {
        if(e.getSource() == vista.btnCalcular){
            ...
            vista.txtLitrosrestantes.setText(bomba.revisarInventario() + "");
        }
