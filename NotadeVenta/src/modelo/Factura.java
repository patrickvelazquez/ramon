...
public class Factura extends NotaVenta
{
    ...
    public Factura(String rfc, String nombreCliente, String domicilio, String fecha, float iva, int numeroNota, int cantidad, String tipoPago,  String concepto, Perecedero producto) 
    {
