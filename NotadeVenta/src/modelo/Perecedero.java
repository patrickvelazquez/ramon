...
public class Perecedero extends Producto 
{
    ...
    public Perecedero(String fechaCaducidad, float temperatura, int idProducto, String unidadProducto, String nombreProducto, float precioUnitario) {
    ...
    public float precioProducto() 
    {
        ...
        if("Kilogramos".equals(getUnidadProducto()))
        {
            comision = 0.03f*getPrecioUnitario();
            total = getPrecioUnitario()+comision+ganancia;
        }
        else if("Litros".equals(getUnidadProducto()))
        {
